function [t] = dft_interlayer_coupling(vector, theta_to, theta_from, a, orbit_to, orbit_from)
    ...
    theta21 = ac - theta_from;% - pi/6;
    %%{
    if (orbit_from == 2) % B orbital
    ...
    theta12 = (ac+pi) - theta_to;% - pi/6;
    %%{
    if (orbit_to == 2) % B orbital
